...
template <bool BType, typename T = void>
using enable_if_t = typename std::enable_if<BType, T>::type;
template <bool BType, typename T, typename FType>
using conditional_t = typename std::conditional<BType, T, FType>::type;
template <bool BType> using bool_constant = std::integral_constant<bool, BType>;
template <typename T>
...
template <bool BType = false> constexpr auto count() -> size_t { return BType ? 1 : 0; }
template <bool B1Type, bool B2Type, bool... Tail> constexpr auto count() -> size_t {
  return (B1Type ? 1 : 0) + count<B2Type, Tail...>();
}
